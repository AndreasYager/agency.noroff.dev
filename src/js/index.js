...
import { displayBaseLayout } from './ui/index.js';
import { singleApplicationTemplate } from './templates/application/student/singleApplicationTemplate.js';
import { setLoginFormListener } from './listeners/auth/index.js';
import { showRegFormListener } from './listeners/auth/showRegFormListener.js'; // don´t need this
import { renderListings } from './templates/listings/renderListings.js';
import { editListingListener } from './listeners/post/editListings.js';
import { profileRouter } from './listeners/profile/index.js';
import { adminRouter } from './views/admin/adminRouter.js';
import { setRegisterFormListenerApplicant } from './listeners/auth/index.js'; // for applicant
import { setRegisterFormListenerCompany } from './listeners/auth/index.js'; // for company
import { createListing } from './listeners/post/createListing.js';
import { postApplication } from './listeners/post/postApplication.js';
import { showListings } from './views/admin/showListings.js';
